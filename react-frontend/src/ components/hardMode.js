...
class HardModeComponent extends React.Component{
    ...
    gameKeyInput(e) {
        if (e.key === 'Enter') {
            ...
            //make a guess
            if (expression.length === children.length && !this.state.model.won && !this.state.model.lost) {
...
export default HardModeComponent;